    ...
    <nav className="fixed top-0 w-full z-50 bg-black/40 backdrop-blur-md border-b border-orange-500 shadow-lg shadow-cyan-400/10">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/coming-soon" className="hover:text-orange-400 transition">PumpaVerse</Link>
          ...
          <a href="https://t.me/pumpatoken" target="_blank"><Image src="/icon-telegram.png" alt="Telegram" width={24} height={24} /></a>
          <a href="https://x.com/Pumpa_Cto" target="_blank"><Image src="/icon-twitter.png" alt="Twitter" width={24} height={24} /></a>
          <a href="https://www.tiktok.com/@pumpa.token" target="_blank"><Image src="/icon-tiktok.png" alt="TikTok" width={24} height={24} /></a>
          <LightSwitch />
        </div>
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4 space-y-2 text-center bg-black/90 backdrop-blur">
          ...
          <Link href="/coming-soon" onClick={closeMenu} className="block text-orange-300 hover:text-white">PumpaVerse</Link>
